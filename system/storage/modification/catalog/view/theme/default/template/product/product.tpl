          ...
          <div id="product">
            ...
            <div class="form-group<?php echo ($option['required'] ? ' required' : ''); ?>">
              ...
              if(substr($option['o_cata'], 0, 1) == '0') { ;  
                      $qq = 1; ?>
              <select id="ddd" value="<?php echo $option['product_option_id']; ?>" name="option[<?php echo $option['product_option_id']; ?>]" class="form-control input-option<?php echo $option['product_option_id']; ?>">
                <option value=""><?php echo $text_select; ?></option>
                <?php foreach ($option['product_option_value'] as $option_value) { ?>
                 <option data-id="<?php echo $option_value['option_value_id'] ?>" value="<?php echo $option_value['product_option_value_id']; ?>" data-points="<?php echo (isset($option_value['points_value']) ? $option_value['points_value'] : 0); ?>" data-prefix="<?php echo $option_value['price_prefix']; ?>" data-price="<?php echo $option_value['price_value']; ?>"><?php echo $option_value['name']; ?>
