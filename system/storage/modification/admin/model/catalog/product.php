...
class ModelCatalogProduct extends Model {
	public function addProduct($data) {
		...
		if (isset($data['product_option'])) {
           ...
           if ($product_option['type'] != 'select') { 
						...
						$this->db->query("INSERT INTO " . DB_PREFIX . "product_option SET product_id = '" . (int)$product_id . "', option_id = '" . (int)$product_option['option_id'] . "', o_cata = '" . $product_option['o_cata'] . "', o_catb = '" . $product_option['o_catb'] . "', required = '" . (int)$product_option['required'] . "'");
      ...
      $product_option_value['o_copb'][$key] = str_replace('z', $ni, $value);
                                                         ...
                                                         $no_serb .= '-';
							$this->db->query("INSERT INTO " . DB_PREFIX . "product_option_value SET product_option_id = '" . (int)$product_option_id . "', product_id = '" . (int)$product_id . "', option_id = '" . (int)$product_option['option_id'] . "', option_value_id = '" . (int)$product_option_value['option_value_id'] . "', quantity = '" . (int)$product_option_value['quantity'] . "', subtract = '" . (int)$product_option_value['subtract'] . "', price = '" . (float)$product_option_value['price'] . "', price_prefix = '" . $this->db->escape($product_option_value['price_prefix']) . "', points = '" . (int)$product_option_value['points'] . "', points_prefix = '" . $this->db->escape($product_option_value['points_prefix']) . "', weight = '" . (float)$product_option_value['weight'] . "', weight_prefix = '" . $this->db->escape($product_option_value['weight_prefix']) . "', no_ser = '" . $no_ser . "',  no_serb = '" . $no_serb . "',  o_copa = '" . $this->db->escape(json_encode($product_option_value['o_copa'])) . "', o_copb = '" . $this->db->escape(json_encode($product_option_value['o_copb'])) . "'");
						}
					}
				} else {
	...
	public function editProduct($product_id, $data) {
		...
		if (isset($data['product_option'])) {
           ...
           if ($product_option['type'] != 'select') { 
						...
						$this->db->query("INSERT INTO " . DB_PREFIX . "product_option SET product_option_id = '" . (int)$product_option['product_option_id'] . "', product_id = '" . (int)$product_id . "', option_id = '" . (int)$product_option['option_id'] . "', o_cata = '" . $product_option['o_cata'] . "', o_catb = '" . $product_option['o_catb'] . "', required = '" . (int)$product_option['required'] . "'");
  ...
  public function getSellerProducts($data = array()) {
	...
	public function getProductOptions($product_id) {
		...
		foreach ($product_option_query->rows as $product_option) {
			...
			foreach ($product_option_value_query->rows as $product_option_value) {
				$product_option_value_data[] = array(
                                        'o_copa'                   => $product_option_value['o_copa'],
	...
	public function getTotalProductsByProfileId($recurring_id) {
        ...
        public function getEv($product_id) {
