...
class ModelCheckoutOrder extends Model {
	...
	public function addOrderHistory($order_id, $order_status_id, $comment = '', $notify = false, $override = false) {
        ...
        // Add auto seller commission .
				if ($order_info['seller_id'] && $this->config->get('config_seller_auto')) {
					$this->load->model('account/catalog/seller');

					$this->model_account_catalog_seller->addTransaction($order_info['seller_id'], $order_info['seller_commission'], $order_id);
				}
				...
				foreach ($order_product_query->rows as $order_product) {
                    ...
                    if(empty($order_option_query->num_rows)) {
