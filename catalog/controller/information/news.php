	...
	public function index() {
		...
		foreach ($all_news as $news) {
			$data['all_news'][] = array (
				...
				'image'			=> $this->model_tool_image->resize($news['image'], 180, 180),
				'description' 	=> (utf8_strlen(strip_tags(html_entity_decode($news['short_description'], ENT_QUOTES))) > 350 ? utf8_substr(strip_tags(html_entity_decode($news['short_description'], ENT_QUOTES)), 0, 350) . '...' : strip_tags(html_entity_decode($news['short_description'], ENT_QUOTES))),
